...
Third, stratifying the satellite record by historical development ring reveals that each ring carries a distinctive green and thermal signature today. The attribution of these signatures to specific planning regimes is inferential---the Landsat record begins in 1990, decades after the French colonial and wartime periods ended---and rests on the spatial coincidence of development rings with historical administrative records, not direct observation of pre-1990 land cover change. With that caveat:

\begin{itemize}
    \item The \textbf{pre-1972 core} was already largely concrete by 1990 and showed the flattest trajectory thereafter. It supports 2.4 million residents on a limited park infrastructure \citep{gibert2018}, and the satellite record captures only its continued densification, not the original loss of green.
    \item The \textbf{1972--1976 ring} has the lowest median green cover of any era and the steepest observed green loss trend (1990--2020), consistent with historical accounts of unplanned wartime refugee settlement.
    \item The \textbf{1976--2000 ring} had space for green but the satellite record shows rapid conversion to built-up land, particularly between 2000 and 2005. Two of three green deserts fall within this ring.
    \item The \textbf{market-era ring} demonstrates that green provision is achievable within the same city: Phú Mỹ Hưng (District 7), master-planned in the 1990s with green corridors, achieves 31.8\% green cover and 69.5\,m$^2$/person accessible canopy---an order of magnitude above the green deserts.
\end{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{../hcmc/figures/study_area_rings.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../hcmc/figures/eda_spatial_fvc_lst.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../hcmc/figures/eda_lst_fvc_regression.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{../hcmc/figures/eda_lst_residual_map.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../hcmc/figures/temporal_green_lst_rings.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../hcmc/figures/temporal_scissors_by_ring.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../hcmc/figures/temporal_heatmap_table.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../hcmc/figures/temporal_stacked_green_area.png}
